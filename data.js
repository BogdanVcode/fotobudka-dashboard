...
window.PROJECT_DATA = {
  ...
  "subsystems": [
    ...
    },
    {
      ...
      "name": "Принтер",
      "status": "NEEDS VERIFICATION",
      "note": "Професійний термосублімаційний; бюджет близько 50 000 грн."
    },
    {
      "id": "09",
      "name": "Оплата",
      "status": "NEEDS VERIFICATION",
      "note": "Вендинговий термінал; Nayax VPOS Touch — кандидат."
    },
    {
      "id": "10",
      "name": "Живлення",
      "status": "NEEDS VERIFICATION",
      "note": "Ціль 30 хвилин повної роботи; потрібні вимірювання та розрахунок."
    },
    {
      "id": "11",
      "name": "Автоматика",
      "status": "NEEDS VERIFICATION",
      "note": "Окремий MCU; ESP32 — кандидат."
    },
    {
      "id": "12",
      "name": "Мережа",
  ...
  "components": [
    {
      ...
      "model": "Єдиний каркас 20×20 і обшивка 16 мм, ревізія 05",
      "status": "NEEDS VERIFICATION",
      "confidence": "D",
      "priceUah": null,
      "budgetUah": null,
      ...
      "verifiedAt": null,
      "specifications": "[C] 1600×1000×2200; труба 20×20×2; одна обшивка 16 мм; вхід 964, звуження 530; лавка 872×386. Один люк у правій стіні 614×1364. Каркас модуля всередині (X≥1326). Стельова порожнина 100 мм. Без водозбірника.",
      ...
      "verify": "Міцність рами і стиків, повна присадка, монтаж ліфта, скло, світловий і тепловий стенди. Виробничого випуску немає."
    },
    {
      "id": "CAM-001",
      "subsystem": "02",
    ...
    },
    {
      ...
      "budgetUah": null,
      "quantity": 1,
      "url": "https://cncprom.ua/ua/p1089207068-modul-linejnogo-peremescheniya.html",
      "store": "cncprom.ua — посилання користувача; не перевірено",
      "verifiedAt": null,
      "specifications": "За описом користувача: ремінний модуль. Хід, розміри, навантаження, вал, шків і комплектність: TODO: VERIFY. Не виводити параметри з назви моделі.",
      "compatibility": "TODO: VERIFY",
      "alternatives": "Не обрано; заміна SELECTED потребує окремого рішення.",
      "reason": "Прямий вибір користувача; не замінювати.",
      "verify": "Креслення, фактичний хід, вертикальне навантаження, шків/передача, інтерфейс вала, кріплення, комплектація, ціна, поведінка без живлення."
    },
    {
      "id": "MOT-002",
      "subsystem": "05",
    ...
    },
    {
      ...
      "store": "TODO: VERIFY",
      "verifiedAt": null,
      "specifications": "Обов’язково: A4, двостороннє сканування за один прохід, TWAIN і WIA.",
      "compatibility": "USB або Ethernet з внутрішнім ПК. DS-640 відхилено, бо він односторонній.",
      "alternatives": "Конкретну модель не обрано; не підміняти вимогу випадковим сканером.",
      "reason": "Функціональну конфігурацію зафіксував користувач, але модель ще потребує вибору.",
      "verify": "Габарити, Windows 11, TWAIN/WIA, duplex, ресурс роликів, автоподача, повернення оригіналу, ціна."
    },
    {
      "id": "PAY-001",
      "subsystem": "09",
    ...
    },
    {
      ...
      "store": "TODO: VERIFY",
      "verifiedAt": null,
      "specifications": "Вимога: приблизно 30 хвилин повноцінної роботи.",
      "compatibility": "TODO: VERIFY",
      "alternatives": "Не обрано; заміна SELECTED потребує окремого рішення.",
      "reason": "Позиція для виконання вимог користувача; точний підбір не виконано.",
      "verify": "NEEDS CALCULATION у запиті: вимірювання середніх і пікових навантажень; UPS / LiFePO4 / power station не обрано."
    },
    {
      "id": "PWR-002",
      "subsystem": "10",
  ...
  "knowledgeGraph": {
    ...
    "nodes": [
      ...
      },
      {
        "id": "MOT-001",
        "title": "TBD45-500",
        "file": "docs/obsidian/04_CAMERA_LIFT/TBD45-500.md",
        "category": "hardware",
        "description": "Ремінний лінійний модуль"
      },
      {
        "id": "MOT-002",
        "title": "NEMA 23",
  ...
  "conceptDesign": {
    ...
    "budgetDocument": "docs/design/BUDGET-06.md",
    "budgetData": "docs/design/budget-06.json",
    "cutlist": "docs/design/CUTLIST-06.md",
    "rearAccess": true,
    "skinThicknessMm": 16,
    ...
    "moduleFrame": "V-Slot AD31 T5: 20×20 для стійок/поперечок, 40×20 для чотирьох несучих балок полиць; ЛДСП 16 мм кріпиться щільно по периметру через T-гайки M5",
